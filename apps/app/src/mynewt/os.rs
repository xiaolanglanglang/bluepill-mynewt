...
extern "C" {
    #[doc = " @brief Converts an OS error code (`OS_[...]`) to an equivalent system error"]
    #[doc = " code (`SYS_E[...]`)."]
    #[doc = ""]
    #[doc = " @param os_error              The OS error code to convert."]
    #[doc = ""]
    #[doc = " @return                      The equivalent system error code."]
    pub fn os_error_to_sys(os_error: os_error_t) -> ::cty::c_int;
}
#[repr(C)]
pub struct os_stack {
    _unused: [u8; 0],
...
pub struct os_time_change_info {
    ...
    #[doc = " True if the time was not set prior to change."]
...
extern "C" {
    #[doc = " Indicates whether the time has been set."]
    #[doc = ""]
    #[doc = " @return                      true if time is set; false otherwise."]
...
extern "C" {
    ...
    pub fn os_malloc(size: size_t) -> *mut ::cty::c_void;
}
extern "C" {
...
extern "C" {
    ...
    pub fn os_realloc(ptr: *mut ::cty::c_void, size: size_t) -> *mut ::cty::c_void;
}
...
#[doc = " Structure containing information about a running task"]
#[repr(C)]
pub struct os_task {
    #[doc = " Current stack pointer for this task"]
    pub t_stackptr: *mut os_stack_t,
    #[doc = " Pointer to bottom of this task's stack"]
    pub t_stackbottom: *mut os_stack_t,
...
extern "C" {
    #[doc = " Return pointer to top of stack for given task"]
    #[doc = ""]
    #[doc = " @param t The task"]
    #[doc = ""]
    #[doc = " @return pointer to top of stack"]
    pub fn os_task_stacktop_get(t: *mut os_task) -> *mut os_stack_t;
}
extern "C" {
...
extern "C" {
    #[doc = " Get following info about specified task"]
    #[doc = " - Priority"]
    #[doc = " - Task ID"]
    #[doc = " - State (READY, SLEEP)"]
    #[doc = " - Total Stack Usage"]
    ...
    #[doc = " - Task Name"]
    #[doc = ""]
    #[doc = "  @param task The task to get info about"]
    #[doc = "  @param oti  The OS task info structure to fill out."]
    pub fn os_task_info_get(task: *const os_task, oti: *mut os_task_info);
}
